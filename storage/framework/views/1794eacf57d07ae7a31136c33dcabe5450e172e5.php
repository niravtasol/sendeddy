...
<a href="javscript:void(0);" class="logo">
  ...
  <span class="logo-mini"><b>Send</b>EDDY</span>
  <!-- logo for regular state and mobile devices -->
  <span class="logo-lg"><b>Send</b>EDDY</span>
</a>
	...
	<ul class="nav navbar-nav">
	  ...
	  <li class="dropdown user user-menu">
		...
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">
		  ...
		  <span class="hidden-xs"><?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->lastname); ?></span>
		</a>
		<ul class="dropdown-menu">
		  ...
		  <li class="user-footer">
			...
			<div class="pull-right">
			  <a href="<?php echo e(route('logout')); ?>" class="btn btn-default btn-flat" onclick="event.preventDefault();                                                 document.getElementById('logout-form').submit();">Sign out</a>
