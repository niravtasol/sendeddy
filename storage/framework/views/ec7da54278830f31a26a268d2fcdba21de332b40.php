...
<div class="main-slider-section">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image:url(<?php echo e(asset('/images/banner1.jpg')); ?> )">
                    <div class="container">
                        <div class="slide-txt">
                            <div class="txt1">
                                DON’T
                ...
                <div class="swiper-slide" style="background-image:url(<?php echo e(asset('/images/1.jpg')); ?> )"></div>
            </div>
            <!-- Add Pagination -->
